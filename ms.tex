...
\caption{\label{fig:pspecs} Left to right from top: power spectra centered on redshifts 10.3,8.5, 7.9, 7.7 and 7.6 (frequencies: 127, 149.5, 159.5 164.5, and 167 MHz) at an effective bandwidth of 10MHz or redshift range 0.5  }
\end{figure}
\section{Results}
\label{sec:results}
